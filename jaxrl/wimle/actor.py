...
def update(key: PRNGKey, actor: Model, critic: Model, temp: Model, batch: Batch) -> Tuple[Model, InfoDict]:
    def actor_loss_fn(actor_params: Params) -> Tuple[jnp.ndarray, InfoDict]:
        dist, _, std = actor.apply({'params': actor_params}, batch.observations, return_params=True)
